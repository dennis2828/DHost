...
export default function Home() {
  return (
    <Container>
      ...
      <section className="mt-3 mb-28">
        <p className="md:text-center text-softGray tracking-wide">
          <span className="font-bold underline">
            {" "}
            Host images for free with ease!
          </span>{" "}
          Upload your images and get a shareable link instantly. We store them
          securely on Discord servers while keeping the link under our domain
          for a clean, professional look. No limits, no hassle—just fast,
          reliable image hosting.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-5">
          <Button className="bg-lightCyan hover:bg-lightCyan w-full max-w-[250px] hover:-translate-y-1 transition-all ">Start uploading now!</Button>
          <Button variant={"outline"} className="border-lightCyan hover:bg-lightCyan w-full max-w-[250px] hover:-translate-y-1 transition-all"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-file-code"><path d="M10 12.5 8 15l2 2.5"/><path d="m14 12.5 2 2.5-2 2.5"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/></svg>Docs</Button>
        </div>
      </section>
